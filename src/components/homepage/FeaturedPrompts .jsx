...
const FeaturedPrompts = ({ featured = [] }) => {
  return (
    <div className="bg-[#080d08] py-24 relative overflow-hidden">
      ...
      >
        <div className="inline-flex items-center gap-2 bg-[#AAFF00]/[0.08] border border-[#AAFF00]/20 text-[#AAFF00] text-[10px] font-bold tracking-[0.13em] uppercase px-4 py-1.5 rounded-full mb-5">
        ...
        <p className="text-[14px] text-white/40 max-w-[400px] mx-auto leading-[1.7]">
