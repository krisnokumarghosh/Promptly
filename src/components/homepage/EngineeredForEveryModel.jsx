        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3">
          {MODELS.map(({ icon, label }) => (
            ...
            >
              ...
              {/* Label */}
              <span
                className={`${jetbrainsMono.className} text-[9px] text-white/40 group-hover:text-white/60 tracking-widest leading-[1.4] text-center transition-colors duration-200`}
              >
                {label}
              </span>
            </div>
